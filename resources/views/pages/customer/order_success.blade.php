    ...
    <section class="py-5 bg-white d-flex align-items-center justify-content-center" style="min-height: 75vh;">
        <div class="container text-center" style="max-width: 600px;">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center gap-3">
                ...
                <a href="{{ route('order') }}" class="btn btn-action-main m-0 fw-bold text-uppercase d-flex justify-content-center align-items-center" style="width: 240px; height: 50px; font-size: 13px; letter-spacing: 1px;">
                    Lihat Pesanan
                </a>
