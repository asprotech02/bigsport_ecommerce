...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-white font-weight-bold">Kelola Kategori</h1>
                            ...
                            <td class="pe-4 text-end">
                                <div class="d-flex justify-content-end align-items-center" style="gap: 6px;">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category->id) }}" 
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-outline-danger px-2.5 py-1.5 d-flex align-items-center" title="Hapus Kategori" style="font-size: 0.75rem; border-radius: 6px;">
