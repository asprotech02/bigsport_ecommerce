                                        ...
                                        @if(old('skus'))
                                            @foreach(old('skus') as $index => $oldSku)
                                                <tr class="sku-row" data-index="{{ $index }}" style="border-bottom: 1px solid rgba(255, 255, 255, 0.03);">
                                                    ...
                                                    <td class="ps-3">
                                                        <input type="text" name="skus[{{ $index }}][size]" value="{{ $oldSku['size'] }}" class="form-control form-control-sm" required>
                                                    </td>
                                                    <td>
                                        ...
                                        @else
                                            ...
                                            @foreach($product->skus as $sku)
                                                <tr class="sku-row" data-index="{{ $loop->index }}" data-sku-id="{{ $sku->id }}" style="border-bottom: 1px solid rgba(255, 255, 255, 0.03);">
                                                    ...
                                                    <td class="ps-3">
                                                        <input type="text" name="skus[{{ $loop->index }}][size]" value="{{ $sku->size }}" class="form-control form-control-sm" required>
                                                    </td>
                                                    <td>
