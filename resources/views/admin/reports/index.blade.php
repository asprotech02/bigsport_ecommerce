    ...
    <div class="card shadow border-0 mb-4" style="overflow: visible !important;">
        ...
        <div class="card-body" style="overflow: visible !important;">
            <form action="{{ route('admin.reports.index') }}" method="GET" class="row align-items-end g-3" style="overflow: visible !important;">
                ...
                <div class="col-md-6 d-flex align-items-center" style="gap: 12px; overflow: visible !important;">
                    <button type="submit" class="btn btn-primary mr-2"><i class="fas fa-filter me-1"></i> Filter Data</button>
                    
                    <div class="btn-group shadow-sm" style="overflow: visible !important;">
                        <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-download me-1"></i> Export Laporan
                        </button>
                        <ul class="dropdown-menu border-0 shadow" style="z-index: 1050 !important;">
                            <li>
                                <a class="dropdown-item py-2" href="{{ route('admin.reports.csv', ['start_date' => request('start_date', $startDate->format('Y-m-d')), 'end_date' => request('end_date', $endDate->format('Y-m-d'))]) }}">
                                    <i class="fas fa-file-excel text-success me-2"></i> Export as Excel/CSV
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2" href="{{ route('admin.reports.pdf', ['start_date' => request('start_date', $startDate->format('Y-m-d')), 'end_date' => request('end_date', $endDate->format('Y-m-d'))]) }}">
                                    <i class="fas fa-file-pdf text-danger me-2"></i> Export as Premium PDF
                                </a>
                            </li>
                        </ul>
                    </div>
